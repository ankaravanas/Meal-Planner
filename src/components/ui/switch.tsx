...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-secondary data-[state=unchecked]:bg-muted",
      "focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-secondary/20 focus-visible:ring-offset-2 focus-visible:ring-offset-background",
